...
public class FeedbackController {
    ...
    public Feedback addOrEditFeedback(@RequestParam("feedbackId")int feedbackId, @RequestParam("messId")int messId,@RequestParam("feedback")String feedbackData, HttpServletRequest request) {
    ...
    public @ResponseBody
    List<Feedback> listOfFeedbacks(@RequestParam("messId")int messId, HttpServletRequest request) throws MessException {
        String userId = (String) request.getSession().getAttribute("USERID");
        RoleType roleType = (RoleType) request.getSession().getAttribute("ROLE-TYPE");
